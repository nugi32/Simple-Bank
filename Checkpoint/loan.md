...
//-----------------------------------------------------------------  APPROVALS  ----------------------------------
    ...
    function rejectLoan(uint loanId) external onlyemployes nonReentrant {
        caller_zero_Address(msg.sender);
        _invalidId(loanId);
        Loan storage ln = loans[loanId];
    ...
    function approveLoan(uint loanId) external onlyemployes nonReentrant {
        caller_zero_Address(msg.sender);
        _invalidId(loanId);
        Loan storage ln = loans[loanId];
    ...
    function unblacklist(address user) external onlyemployes {
        caller_zero_Address(msg.sender);
        caller_zero_Address(user);
    ...
    function setMonthlyInterestPercent(uint p) external onlyemployes {
        caller_zero_Address(msg.sender);
    ...
    function setPenaltyPercent(uint p) external onlyemployes {
        caller_zero_Address(msg.sender);
    ...
    function setCollateralRatioPercent(uint p) external onlyemployes {
        caller_zero_Address(msg.sender);
    ...
    function setMaxNPLPercent(uint p) external onlyemployes {
        caller_zero_Address(msg.sender);
...
//--------------------------------------------------------------------------  PROFIT  ---------------------------------
    ...
    function setManagementWallet(address payable w) external onlyemployes {
        caller_zero_Address(msg.sender);
    ...
    function takeProfits() external onlyemployes nonReentrant {
        caller_zero_Address(msg.sender);
...
//----------------------------------------------------  UTILITIES  ---------------------------------
    ...
    function TotalLoan() external view onlyemployes returns (uint) {
        caller_zero_Address(msg.sender);
        return loans.length;
    }
