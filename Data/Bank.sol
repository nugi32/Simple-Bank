 ...
 *      Inherits access control from EmployeeAssignment and security from ReentrancyGuard.
 */
abstract contract bank is ReentrancyGuardUpgradeable, AccesControl {
    ...
    /**
     * @notice Emitted when the management wallet address is set or changed.
     ...
     * @param _management_Wallet Address of the management wallet that receives fees.
     * @dev Sets default transfer and deposit fees to 1%.
     */
    function initialize(address payable _management_Wallet) public initializer {
    ...
    /**
     * @notice Transfers funds from the sender to another registered user.
